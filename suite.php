...
$mysqli = new mysqli($db_host, $db_username, $db_password,$db_name);
    // Mysql/ database quries for users
	$results = $mysqli->query("SELECT * FROM rooms where av='Yes' and type='Suite' ");
    if ($results) { 
        ...
        while($obj = $results->fetch_object())
        {
            ...
            //suite Rooms type with images details
