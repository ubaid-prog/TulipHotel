...
<!-- content -->
		<section id="content">
            ...
            <div class="wrap-col">
            <?php // database linking to the rooms available
			$db_username = 'root';
$db_password = '';
$db_name = 'obaid1';
$db_host = 'localhost';
...
$checkout=$_POST['checkout'];
			...
			?>
				<h2>Available Rooms and Suite </h2>
                
 <?php
// creating database quries
$mysqli = new mysqli($db_host, $db_username, $db_password,$db_name);
    
	$results = $mysqli->query("SELECT * FROM rooms where type='$type'");
    if ($results) { 
        ...
        while($obj = $results->fetch_object())
        {
            ...
            // rooms avaiability and description price etc
