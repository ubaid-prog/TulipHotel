...
$mysqli = new mysqli($db_host, $db_username, $db_password,$db_name);
    ...
    if ($results) { 
        ...
        {
			?>
				<form id="ContactForm" enctype="multipart/form-data" action="pagequery.php" method="post"  onSubmit="return validateForm()">
					<div>
                    Page Title <div class="wrapper">    <input type="text" id="title" name="title" class="input" value="<?php echo $obj->pagename; ?>" ></div>
						
                    Content <div class="wrapper">  <textarea name="content"  cols="100" rows="25"> <?php echo $obj->content; ?></textarea></div>
