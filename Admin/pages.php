...
$mysqli = new mysqli($db_host, $db_username, $db_password,$db_name);
	...
	$results = $mysqli->query("SELECT * FROM pages ORDER BY id desc");
    if ($results) { 
        ...
        while($obj = $results->fetch_object())
        {
			...
			echo '<figure class="left marg_right1"><img src="images/page.png" alt="" width="200" height"100"> </figure>';
            echo '<p class="pad_bot2" style="font-size:20px"><b>'.$obj->pagename.'</b>';
		
			echo '<p class="pad_bot2" style="height:80px"><b>DESCRIPTION:</b>'.$obj->des.'</p>';
			

            echo '<a href="editpage.php?id='.$obj->id.'" class="button4" style="margin-right: 10px;"> Edit</a>';
			 echo '<a href="#" class="button4" style="margin-right: 10px;"> Delete</a>';
