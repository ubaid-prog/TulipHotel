  ...
  ?>
            ...
            <thead>
              <tr>
				...
				<th width="63" scope="col">Room Type</th> 
                <th width="63" scope="col">Name</th>       
                 
                <th width="82"  scope="col">Email</th>
                 <th width="82" scope="col">Review</th>
...
$mysqli = new mysqli($db_host, $db_username, $db_password,$db_name);
	...
	$results = $mysqli->query("SELECT * FROM reviews");
    if ($results) { 
