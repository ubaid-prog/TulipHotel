            ...
            <thead>
              <tr>
                ...
                <th width="82"  scope="col">Email</th>
                 <th width="82" scope="col">Comment</th>
...
$mysqli = new mysqli($db_host, $db_username, $db_password,$db_name);
	...
	$results = $mysqli->query("SELECT * FROM blog_comments");
    if ($results) { 
			...
			?>
              <tr>
               ...
               <td align="center"><?php echo $obj->email;  ?></td>
                <td align="center"><?php echo $obj->comment;  ?></td>
                <td align="center"><?php echo $obj->time;  ?></td>
                <td align="center"><?php echo $obj->day;  ?></td>
                <td align="center"><?php echo $obj->date;  ?></td>

                            
               <td align="center" width="39"><a href="deletecomment.php?id=<?php echo $obj->id; ?>"> Delete</a></td>
               <td width="1">
