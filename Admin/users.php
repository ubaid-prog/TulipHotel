...
<!-- content -->
  ...
  ?>
			  ...
			  <div class="wrapper">
              <table width="" cellpadding="0" cellspacing="0" id="box-table-a" summary="Employee Pay Sheet" border="2">
            <thead>
              <tr>
                
                <th width="50"  scope="col">id</th>
                <th width="63" scope="col">First Name</th>
                <th width="64"  scope="col">Last Name</th>
                <th width="70" scope="col">Username</th> 
                <th width="82"  scope="col">Email</th>
                 <th width="82" scope="col">Password</th>
                <th width="110" scope="col">Address</th>
                <th width="70" scope="col">Mobile NO</th>                            
        ...
        while($obj = $results->fetch_object())
        {
			?>
              <tr>
               ...
               <td align="center"><?php echo $obj->fname;  ?></td>
               <td align="center"><?php echo $obj->lname;  ?></td>
                ...
                <td align="center"><?php echo $obj->mobile;  ?></td>
                            
               <td align="center" width="39"><a href="deleteuser.php?id=<?php echo $obj->id; ?>"> Delete</a></td>
               <td width="1">
